...
Console.WriteLine("Following is an example of a Binary Tree with adding, inorder output, reversorder output and proper deleting of values");
Console.WriteLine("If you find any mistakes or want to give feedback contact the author Gabriel Lugmayr.");

var binaryTree = new BinaryTree<int>();

Console.WriteLine("Adding Numbers: 50, 25, 75, 40, 38, 23, 24, 10, 100\n");
binaryTree.Add(50);
binaryTree.Add(25);
binaryTree.Add(75);
binaryTree.Add(40);
...
Console.WriteLine("In Order Output:");
binaryTree.InOrderOutput();
Console.WriteLine("\nReverse Order Output:");
binaryTree.ReverseOrderOutput();
